...
- (void)searchWithText:(NSString *)text
{
    ...
    if ([netConnect isEqualToString:@"OK"]) {
        NSString *serverURL = [[NSString stringWithFormat:@"%@/api/fullSearch/search",kTaskURL] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];//转码成UTF-8  否则可能会出现错
