...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        CGFloat thumbHeight = frame.size.height - kOAPDFCellTitleHeight - 10; // - 40.0f
        ...
        self.pdfThumbView.center = CGPointMake(frame.size.width / 2.0, thumbHeight / 2.0);
        ...
        CGRect tagFrame = CGRectMake(tagX, 0, kTagViewWidth, kTagViewHeight); //65.0f,68.0f
        ...
        CGFloat x = self.pdfThumbView.frame.origin.x + self.pdfThumbView.frame.size.width - 32;
        self.deleteBtn.frame = CGRectMake(x, 0, 32, 32);
...
//        self.contentView.layer.borderColor = [[UIColor lightGrayColor] CGColor];
        ...
        // 10. 添加流程类型
        self.missiveType = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 0.0f, frame.size.width * 0.9, 40)];
        self.missiveType.center = CGPointMake(frame.size.width * 0.5, 80);
        ...
        self.missiveType.textColor = kThemeColor;
