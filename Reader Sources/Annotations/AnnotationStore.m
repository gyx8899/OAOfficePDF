...
- (void) addImage:(CGImageRef)imageRef inRect:(CGRect)rect toPage:(int)page {
    [self addAnnotation:[ImageAnnotation imageAnnotationWithImage:imageRef inRect:rect] toPage:page];
}
